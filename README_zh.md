# 基于本地RAG的学术代理
### 该项目是基于LangChain 1.2版本开发的学术智能代理，主要旨在解决大语言模型中的幻觉和数据隐私问题。支持TXT、PDF文档本地上传，构建RAG知识库，并设计Agent进行论文分析、比对和检索。可以通过Streamlit生成本地Web界面，进行可视化操作。该模型可以独立定制，以满足额外的需求，详细的项目结构参见README.md文件。主要用于入门基础学习
...
![图片.png](https://tc-cdn.processon.com/po/658679616ff9af23035e9c84-698315b8af380f3b56b28168)
